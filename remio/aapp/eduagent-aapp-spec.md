...
> 由 8 个分工明确的 Agent 协同产出讲义、题目、代码、思维导图、PPT、拓展阅读、动画脚本，
> 并对疑问做苏格拉底式引导答疑。
...
共 10 个端点，与 8 个 Agent 一一对应（VideoAgent 作为可选端点，联网搜 B 站视频）。
...
| 多智能体架构 | 8 个 Agent 独立端点、明确分工、Router→Profile→并行生成 协同编排 |
