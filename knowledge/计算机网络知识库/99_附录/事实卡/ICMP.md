...
keywords: ["ICMP", "事实卡"]
aliases: ["ICMP"]
summary: "ICMP 用于 IP 网络中的差错报告和诊断，ping 常使用 Echo Request/Reply。"
learning_goals: ["理解核心概念", "解释典型流程", "识别常见误解"]
prerequisites: []
related_docs: []
related_concepts: ["ICMP", "事实卡"]
graph_nodes: []
graph_edges: []
...
## 标准表述
ICMP 用于 IP 网络中的差错报告和诊断，ping 常使用 Echo Request/Reply。

## 适用场景
ping、traceroute 和网络不可达分析。
