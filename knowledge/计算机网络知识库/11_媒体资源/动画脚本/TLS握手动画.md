...
keywords: ["动画", "TLS", "握手"]
aliases: ["CN-MEDIA-008"]
summary: "用箭头和消息流展示 TLS 握手过程的动画脚本。"
learning_goals: ["快速召回标准事实", "支持题库与导师 Agent 给出一致表述"]
prerequisites: []
related_docs: []
related_concepts: ["动画", "TLS", "握手"]
graph_nodes: []
graph_edges: []
...
rag:
  ...
  embedding_hints: ["动画", "TLS", "握手", "CN-MEDIA-008"]
quality:
  factual_risk: "medium"
...
## 1. 资源目标
用箭头和消息流展示 TLS 握手过程的动画脚本。

## 2. 内容结构
1. 问题引入：学生常见困惑。
2. 分层定位：指出该主题属于哪一层。
3. 核心过程：用箭头、状态或时间轴展示机制。
4. 易错纠偏：引用事实卡中的常见误解。
5. 小测：生成 1-2 个检索或判断问题。
...
## 4. 相关链接
- [[计算机网络知识库/99_附录/事实卡/TLS握手过程]]
- [[计算机网络知识库/99_附录/事实卡/数字证书]]
- [[计算机网络知识库/99_附录/事实卡/防火墙类型]]
- [[计算机网络知识库/99_附录/事实卡/WPA2与WPA3]]
- [[计算机网络知识库/99_附录/事实卡/网络安全三元组]]
