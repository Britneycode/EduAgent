...
keywords: ["Wireshark基础", "实验"]
aliases: ["Wireshark基础"]
summary: "掌握 Wireshark 抓包、过滤、协议树和导出证据的基本流程。"
learning_goals: ["理解核心概念", "解释典型流程", "识别常见误解"]
prerequisites: []
related_docs: []
related_concepts: ["Wireshark基础", "实验"]
graph_nodes: []
graph_edges: []
...
rag:
  ...
  embedding_hints: ["Wireshark基础", "实验", "Wireshark基础"]
quality:
  factual_risk: "medium"
...
## 1. 实验目标
掌握 Wireshark 抓包、过滤、协议树和导出证据的基本流程。
