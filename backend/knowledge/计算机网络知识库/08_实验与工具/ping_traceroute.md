---
doc_id: "CN-LAB-002"
title: "ping_traceroute"
doc_type: "lab"
course: "计算机网络"
course_code: "CN-LLM-WIKI"
chapter: "08_实验与工具"
section: ""
topic: "ping_traceroute"
subtopics: []
knowledge_level: "undergraduate"
difficulty: "medium"
audience: ["高等教育学生", "教师", "多智能体学习系统"]
keywords: ["ping_traceroute", "实验"]
aliases: ["ping_traceroute"]
summary: "使用 ping 与 traceroute/tracert 观察连通性、RTT、TTL 和路径现象。"
learning_goals: ["理解核心概念", "解释典型流程", "识别常见误解"]
prerequisites: []
related_docs: []
related_concepts: ["ping_traceroute", "实验"]
graph_nodes: []
graph_edges: []
...
rag:
  ...
  embedding_hints: ["ping_traceroute", "实验", "ping_traceroute"]
quality:
  factual_risk: "medium"
...
## 1. 实验目标
使用 ping 与 traceroute/tracert 观察连通性、RTT、TTL 和路径现象。
