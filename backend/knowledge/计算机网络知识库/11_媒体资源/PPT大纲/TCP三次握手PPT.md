...
keywords: ["TCP三次握手PPT", "媒体资源"]
aliases: ["TCP三次握手PPT"]
summary: "面向课堂讲解的 TCP 三次握手 PPT 大纲。"
learning_goals: ["理解核心概念", "解释典型流程", "识别常见误解"]
prerequisites: []
related_docs: []
related_concepts: ["TCP三次握手PPT", "媒体资源"]
graph_nodes: []
graph_edges: []
...
rag:
  ...
  embedding_hints: ["TCP三次握手PPT", "媒体资源", "TCP三次握手PPT"]
quality:
  factual_risk: "medium"
...
- 风格：清晰、教学化、少文字、多箭头。
- 约束：不得把教学简化当作绝对事实。
- 必须链接：[[计算机网络知识库/99_附录/事实卡/TCP三次握手]]、[[计算机网络知识库/99_附录/事实卡/DNS解析过程]]、[[计算机网络知识库/99_附录/事实卡/子网划分]]。
