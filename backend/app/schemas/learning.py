...
class TeacherWeakPointItem(BaseModel):
    knowledge_point: str
...
class TeacherQuizPerformanceItem(BaseModel):
    knowledge_point: str
    attempts: int = 0
    average_score: float = 0.0


class TeacherStudentProgressItem(BaseModel):
    user_id: int
    username: str
...
class TeacherDashboardResponse(BaseModel):
    ...
    weak_points: list[TeacherWeakPointItem] = Field(default_factory=list)
    quiz_performance: list[TeacherQuizPerformanceItem] = Field(default_factory=list)
    students: list[TeacherStudentProgressItem] = Field(default_factory=list)
    recommendations: list[str] = Field(default_factory=list)
